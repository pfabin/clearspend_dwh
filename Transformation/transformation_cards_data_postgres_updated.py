...
def main():
    ...
    ### Truncating everything after the decimal point, then converting to string for validation
    ...
    ### Standardising the credit limit and converting negative values to positive, assuming all is USD
