...
def main():
    ...
    for df in pd.read_sql_query(query, conn, chunksize=chunk_size):
        ...
        ### for all online transactions. Later fills the missing values in city as NA.
        ...
        df["errors"] = df["errors"].astype("string").fillna("").str.strip()
        ...
        df = df[
            [
                ...
                "merchant_id", "merchant_city", "is_online", "merchant_state", "zip", "mcc", 
        ...
        with cur.copy(f"""
            ...
            (id, date, client_id, card_id, amount,
             use_chip, merchant_id, merchant_city, is_online, merchant_state,
